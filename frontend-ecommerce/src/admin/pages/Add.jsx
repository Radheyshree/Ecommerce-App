...
const onSubmitHandler = async(e) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3">
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} type="text" placeholder="enter name of product" className="w-full max-w-[500px] px-3 py-2"required/>
        </div>
        <div className="w-full ">
        <p className="mb-2">Product Description</p>
        <textarea onChange={(e)=>setDesc(e.target.value)} value={desc} type="text" placeholder="enter description of product" className="w-full max-w-[500px] px-3 py-2"required/>
        </div>
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
          ...
          <div className="flex gap-2 mt-2">
            ...
            <label className="cursor-pointer" htmlFor="bestseller">Add as BestSeller</label>
          </div>
